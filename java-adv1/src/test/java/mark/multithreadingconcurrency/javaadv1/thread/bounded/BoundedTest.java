...
//        producerFirst(queue);   // 생산자 먼저 실행
    ...
    @Test
    void test_V2() throws InterruptedException {
        // 1. BoundedQueue 선택
...
//        consumerFirst(queue);   // 소비자 먼저 실행
    ...
    @Test
    void test_V3() throws InterruptedException {
        // 1. BoundedQueue 선택
...
//        consumerFirst(queue);   // 소비자 먼저 실행
    ...
    private void consumerFirst(BoundedQueue queue) {
    ...
    private void startProducer(BoundedQueue queue, List<Thread> threads) {
        System.out.println();
        log("생산자 시작");
        for (int i = 1; i <= 3; i++) {
    ...
    private void startConsumer(BoundedQueue queue, List<Thread> threads) {
        System.out.println();
        log("소비자 시작");
        for (int i = 1; i <= 3; i++) {
    ...
    private void printAllState(BoundedQueue queue, List<Thread> threads) {
        System.out.println();
